...
def seed_database(app=None):
    ...
    def _seed():
        db.create_all()
        existing_business = db.session.get(Business, Config.DEFAULT_BUSINESS_ID)
        ...
        db.session.commit()
        print(f"Successfully seeded business '{clinic.name}' with 2 doctors and {len(services)} services!")
